...
namespace outlookaddin
{
    ...
    public static class Encrypt
    {
        ...
        {
            const string chars = "ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789abcdefghjiklmnopqrstuvwxyz";
        ...
        //Encrypt
        public static Tuple<String, String> EncryptString(string plainText, string passPhrase)
        {
            initVector = RandomString(16);
            ...
            memoryStream.Close();
            cryptoStream.Close();
            return Tuple.Create(Convert.ToBase64String(cipherTextBytes), initVector);
        }
        //Decrypt
